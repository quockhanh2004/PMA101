  ...
  return (
    <DrawerContentScrollView {...props}>
      <View style={{ width: '100%', height: '100%' }}>
        <View style={{height:186, padding: 16, backgroundColor: '#238B59', alignItems: 'center' }}>
        <Text style={{ fontSize: 18, fontWeight: 'bold', color:'#FFF'}}>CarRental, Hello</Text>
          <Image
            style={{ width: 80, height: 80,backgroundColor:'#FFF',borderRadius:60, marginTop:20 }}
            source={require('../../assets/images/icPerson.png')} />
          <Text style={{ fontSize: 18, fontWeight: 'bold', color:'#FFF'}}>Bảo Hoàng</Text>
        </View>
        ...
        <View style={{  justifyContent: 'center', alignItems: 'center' }}>
          <View style={{marginTop:350 }}>
            <TouchableOpacity
            onPress={nhanLogin}
              style={{ width: 196, height: 52, borderWidth: 1, borderRadius: 32, borderColor: '#2BAE70', alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ fontSize: 15, fontWeight: '500', lineHeight: 22.5, color: '#2BAE70' }}>Log out</Text>
            </TouchableOpacity>
          </View>
...
const MainDrawer = (props) => {
  return (
    ...
    screenOptions={{
      ...
      <Drawer.Screen name='MainTabNavigation' component={MainTabNavigation}
        options={{
          headerShown: false,
          drawerLabel: 'Home',
